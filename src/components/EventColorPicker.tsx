...
export default function EventColorPicker({ selectedColor, onColorSelect }: EventColorPickerProps) {
  const allColors = [...pastelColors, ...vibrantColors, ...darkModeColors, ...grassColors, ...accessibleColors];
